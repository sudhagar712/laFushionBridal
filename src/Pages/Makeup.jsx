      ...
      <div className=" bg-pink-200 ">
        <div className="flex flex-col md:flex-row items-center gap-8 min-h-[400px]">
          ...
          <div className="md:w-1/2 relative">
            <video
              src={packageVideo}
              className=" shadow-lg w-full h-[400px] md:h-[900px] object-cover"
              autoPlay
              muted
              loop
              playsInline
          ...
          <div className="md:w-1/2  text-center  md:text-left p-3 px-5">
            ...
            <p className="text-gray-700 mb-5 text-xl ">
              <em>Choose from our expertly curated makeup packages tailored for
              brides, parties, and special occasions. Our professionals use
              top-quality products for a flawless finish that lasts.</em>
            </p>
            ...
            <a
              ...
              className="mt-5 inline-block px-5 py-2 mb-10 bg-yellow-500 text-white border-2 border-white rounded hover:bg-yellow-600 transition-all"
            >
              Book Appointment
            </a>
          </div>
